          ...
          <GlassCard variant="strong" padding="lg" hover={false} className="text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-[var(--text-secondary)] max-w-xl mx-auto">
                ...
                проектной компанией, проектным бюро или проектированием — от небольшой команды
                до полного цикла в крупном холдинге. Единая ERP-платформа для проектов,
                ресурсов, документов, финансов и аналитики: контролируйте эффективность
                компании, принимайте решения быстрее и масштабируйте бизнес без потери
                управляемости.
              </p>
