          ...
          <GlassCard variant="strong" padding="lg" hover={false} className="text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-[var(--text-secondary)] max-w-xl mx-auto">
                Получите единую ERP-платформу для управления проектами, ресурсами, документами,
                финансами и аналитикой. Контролируйте эффективность компании, принимайте
                решения быстрее и масштабируйте бизнес без потери управляемости.
              </p>
