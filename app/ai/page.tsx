...
export const metadata: Metadata = {
  ...
  description:
    "Сервис РостПро проверяет проектную и рабочую документацию на соответствие нормам, ИРД и ТЗ, находит коллизии и критические ошибки — от 18 ₽ за лист, отчёт до 2 рабочих дней. Помогает ГИПам и ГАПам соответствовать 309-ФЗ о личной ответственности за качество документации.",
  alternates: { canonical: "/ai" },
};

const heroStats = [
  { value: "18 ₽", label: "за лист документации любого формата" },
...
const faq = [
  ...
  },
  {
    ...
    answer: "18 ₽ за лист документации любого формата — оплата по фактическому объёму.",
  },
  {
