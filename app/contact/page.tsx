...
export const metadata: Metadata = {
  title: "Контакты РостПро — запишитесь на консультацию",
  description:
    "Оставьте заявку на консультацию по системе управления проектами РостПро: ответим на вопросы, покажем платформу на живых данных и дадим 60 дней на тест с гарантией возврата денег.",
...
export default function ContactPage() {
  return (
    <Section size="lg" className="pt-8 sm:pt-12">
      <SectionHeading
        eyebrow="Контакты"
        title="Ответим на ваши вопросы о РостПро за 20 минут"
        description="Оставьте заявку на консультацию — ответим на вопросы о платформе и внедрении на примере ваших проектов и дадим 60 дней на тест с гарантией возврата денег."
      />
