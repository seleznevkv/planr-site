...
export const metadata: Metadata = {
  ...
  description:
    "Сколько стоит РостПро: тарифы отличаются только количеством пользователей, весь функционал и внедрение включены в стоимость на каждом плане — фиксированная цена без скидок.",
