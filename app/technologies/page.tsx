...
export const metadata: Metadata = {
  title: "Технологии и безопасность PlanR — архитектура, хранение данных, интеграции",
  description:
    "Как устроена платформа PlanR: хостинг и резервное копирование, разграничение прав доступа, электронная подпись, интеграции и план развития API.",
...
const infraSections = [
  {
    icon: IconServer,
    title: "Хостинг и локализация данных",
    text: "PlanR размещён на серверах на территории России. Данные компании хранятся и обрабатываются в РФ — в соответствии с требованиями 152-ФЗ о локализации персональных данных.",
  },
  {
    icon: IconCloud,
...
const integrations = [
  ...
  },
  {
    ...
    title: "1С",
    text: "Загрузка данных из 1С в PlanR.",
  },
  {
    icon: IconTelegram,
    title: "Telegram-бот",
    ...
    <>
      <Section size="lg" className="pt-8 sm:pt-12">
        <SectionHeading
          ...
          title="Архитектура, безопасность и интеграции PlanR"
      ...
      <Section>
        <SectionHeading eyebrow="Интеграции" title="Как PlanR обменивается данными с другими системами" align="left" />
