...
const infraSections = [
  {
    ...
    text: "РостПро — российская разработка: платформа и данные компании размещены на серверах на территории России — в соответствии с требованиями 152-ФЗ о локализации персональных данных. Отечественное решение для тех, кому важно импортозамещение.",
  },
  {
    icon: IconCloud,
