...
export const metadata: Metadata = {
  ...
  description:
    "Как устроена платформа РостПро: хостинг и резервное копирование, разграничение прав доступа, электронная подпись, интеграции и план развития API.",
...
const infraSections = [
  {
    ...
    text: "РостПро размещён на серверах на территории России. Данные компании хранятся и обрабатываются в РФ — в соответствии с требованиями 152-ФЗ о локализации персональных данных.",
  },
  {
    icon: IconCloud,
