...
export const metadata: Metadata = {
  ...
  description: "Заявка на консультацию по РостПро отправлена — мы свяжемся с вами в ближайшее рабочее время.",
      ...
      <Reveal className="max-w-xl mx-auto">
        <GlassCard variant="strong" padding="lg" hover={false} className="text-center">
          ...
          <p className="mt-3 text-sm text-[var(--text-secondary)] leading-relaxed">
            ...
            ответить на вопросы о РостПро и, если готовы, обсудить договор.
          </p>
